...
[Legend,pMWTpass,pMWTfailed] = chormaster5('TrinityOnly',pMWT,'convert2mat',true,'displayopt',false); % chor
...
%     data = DataMeta(:,{'mwtid',msr});
    CS = CurveStats_v1707r2(DataMeta,MWTDB,msr);
    MWTSet.Stats.(msr) = CS;

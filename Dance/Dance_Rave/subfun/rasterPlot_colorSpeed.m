%%%%%%for ALL Plate
function [figure1,plateSumm,savename,Tog,MWTsourceID,recordTime] = rasterPlot_colorSpeed(path,start,finish,varargin)
...
for x = 1:numel(pMWT)
    ...
    [S,~,assayTime] = trinitySummary(pMWTp,start,finish,'frameInt',frameInt,'saveoption',saveoption);

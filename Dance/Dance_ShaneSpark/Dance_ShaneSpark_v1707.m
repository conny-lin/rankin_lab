...
MWTDB = MWTSet.MWTDB;
% -------------------------------------------------------------------------
%%                          OBTAIN DATA | 20170821
% -------------------------------------------------------------------------
R = import_trv_table(pMWT,'displayopt',displayopt); % get trv data
R = outerjoin(R,MWTDB(:,{'mwtid','expname','groupname','strain','rx'}),'type','left','MergeKeys',1);
R.dose = R.rx;
MWTSet.Raw = R;

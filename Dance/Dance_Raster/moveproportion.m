function [figure1,SpeedGrad] = moveproportion(Data,time,visible,varargin)
...
if speed_max > gradmax; warning('max speed > %.1f',gradmax); end
r = d(d < 0);
speed_min = mean(r) - 3*std(r);
if speed_min < gradmin; warning('min speed < %.1f',gradmin); end

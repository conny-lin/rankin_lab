function meanspeed_v3(pMWT,pSaveHome,mutant)
...
cd(pSaveHome); 
if nargin >=3
    save('data.mat','wildtype','mutant','cond','groupnameList','-v7.3');
else
    save('data.mat','wildtype','cond','groupnameList','-v7.3');
end
% 
% 
% 
%% CHOR
fprintf('\nconverting Trinity data to mat...\n');
...
D = get_speeddata_fromTrinity(pMWT);
% 
% 
% 
%% VALIDATIONS  ========================================================
...
% save raw data
RawData = D;
cd(pSaveHome); save('data.mat','RawData','-append');
...
cd(pSaveHome); 
save('data.mat','ByGroup','Stats','Db','Tapstart','Tapend','-append');

function [plateSumm,recordTime,savename,MWTsourceID,D] = TrinitySum_multiPlates_v1707(pMWT,finish, start,dur,varargin)
...
for x = 1:numel(pMWT)
    ...
    if isempty(TrinityData)
        [S,~,assayTime,d] = trinitySummary_v1707(pMWTp,start,finish,dur,...

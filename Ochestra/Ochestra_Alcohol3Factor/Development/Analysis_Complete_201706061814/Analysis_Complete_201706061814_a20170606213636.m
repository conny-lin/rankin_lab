...
MWTDBM = load(fullfile('/Volumes/COBOLT/MWT','MWTDB.mat')); % load MWTDB
MWTDB = MWTDBM.MWTDB.text; % pull MWTDB to new 
...
genotype = char(MWTDB.strain.genotype(ismember(MWTDB.strain.strain,strain))); % get genotype
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


%% DANCE ANALYSIS COMPONENTS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% INITIAL SENSITIVITY 
pData_Sen = Dance_InitialEtohSensitivityPct(pMWT,'pSave',pSave); % run initial sensitivity
...
%% REVERSAL
pData_SS = Dance_ShaneSpark5(pMWT,'pSave',pSave);
...
%% ACCELERATION
pData_TAR = Dance_rType2(pMWT,'pSave',pSave,'genotype',genotype); % rType

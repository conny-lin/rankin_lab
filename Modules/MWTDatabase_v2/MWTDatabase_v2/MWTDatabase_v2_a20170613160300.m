...
en = cellfun(@fileparts,pExp,'UniformOutput',0); % get exp name
...
groupnames = cellfun(@fileparts,pG,'UniformOutput',0); % get exp name
...
mwtname = cellfun(@fileparts,pMWT,'UniformOutput',0); % get exp name
% check if zipped

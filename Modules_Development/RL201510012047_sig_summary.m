...
A.initial_diff = D;
A.initial_sig = nan(size(A.strainname));
A.initial_sig(ismember(A.strainname,strain_initial_diff)) = 0.05;
A.initial_sig(~ismember(A.strainname,strain_initial_diff)) = 1;

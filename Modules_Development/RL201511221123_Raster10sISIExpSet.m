...
expsetNameList = MWTD.expset.expset(3:10);
for expsetNameListi = 1:numel(expsetNameList)
    ...
    for x = 1:numel(genes)
        val(regexpcellout(MWTD.mwt.genotype,genes(x))) = true;
    end
